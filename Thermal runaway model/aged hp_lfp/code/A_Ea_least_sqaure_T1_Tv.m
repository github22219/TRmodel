...
Temp=double(Temp(1000:17500));
dTemp_dt=double(dTemp_dt(1000:17500));
...
initialGuess = double([16360819.83, 80000]); % 例如，[A_2的估计值), Ea_2的估计值]
Ub=double([1*10^20,2*10^20]);
...
R_SIM=log(16360819.8) - 83140./(8.314.*Temp);
x=1./Temp;
