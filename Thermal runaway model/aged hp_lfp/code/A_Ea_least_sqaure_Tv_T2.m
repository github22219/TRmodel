...
Temp=double(Temp(25000:39879));
dTemp_dt=double(dTemp_dt(25000:39879));
...
initialGuess = double([760000, 74966]); % 例如，[A_2的估计值), Ea_2的估计值]
Ub=double([1*10^30,2*10^20]);
...
R_SIM=log(760000) - 74966./(8.314.*Temp);
x=1./Temp;
