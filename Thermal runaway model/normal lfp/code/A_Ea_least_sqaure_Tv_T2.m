...
Temp=double(Temp(25000:31944));
dTemp_dt=double(dTemp_dt(25000:31944));
...
initialGuess = double([10^11, 75135.970075]); % 例如，[A_2的估计值), Ea_2的估计值]
...
R_SIM=log(907.78) - 51514./(8.314.*Temp);
x=1./Temp;
